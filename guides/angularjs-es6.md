# Angular 1.x Style Guide - ES6

This is my Angular 1.x Style Guide using ES6.

It was inspired by [Todd Motto's Angular 1.x (ES6) Style Guide](https://github.com/toddmotto/angular-styleguide/blob/master/README.md).
